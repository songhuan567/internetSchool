<template>
    <div class="wrapper">
        ...
        <div class="search">
            <div>
                <el-button type="primary" @click="addMedia"><i class="el-icon-edit" />新增视频</el-button>
            </div>
            <div class="right">
        ...
        <el-table :border="true" :data="list"> 
            ...
            <el-table-column label="视频内容" class="media">
                <template slot-scope="scope" >
...
import { fetchList, updateVideo } from '../../api/video'
